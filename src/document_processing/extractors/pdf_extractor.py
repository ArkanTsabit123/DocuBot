...
class PDFExtractor(BaseExtractor):
    ...
    def validate_file(self, file_path: Union[str, Path]) -> Dict[str, Any]:
        ...
        """
        return self.validate_pdf(file_path)  # Delegate to existing method
...
class PDFExtractor(BaseExtractor):
    ...
    def extract_metadata_only(self, file_path: str | Path) -> Dict[str, Any]:
        """
        Extract only metadata from PDF (faster than full extraction).
    ...
    def extract_images(self, file_path: str | Path, output_dir: str | Path = None) -> List[Dict[str, Any]]:
        """
        Extract images from PDF (requires pdfplumber).
    ...
    def validate_pdf(self, file_path: str | Path) -> Dict[str, Any]:
        """
        Validate PDF file structure and content.
